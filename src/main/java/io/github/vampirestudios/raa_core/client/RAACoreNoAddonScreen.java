...
public class RAACoreNoAddonScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, string, this.width/2, this.height/2 -20, 0xFFFFFF);
        string = new TranslatableText("text.raa_core.no_addon_screen.message.2").getString();
        drawCenteredText(matrices, this.textRenderer, string, this.width/2, this.height/2 - 10, 0xFFFFFF);
        string = new TranslatableText("text.raa_core.no_addon_screen.message.3").getString();
        drawCenteredText(matrices, this.textRenderer, string, this.width/2, this.height/2, 0xFFFFFF);
