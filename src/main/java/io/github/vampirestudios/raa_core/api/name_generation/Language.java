...
public class Language {
    ...
    public static final Language ENGLISH_LEGACY;
    ...
    public static final Language FRENCH_LEGACY;
    public static final Language FRENCH;
    public static final Language CHINESE_LEGACY;
    public static final Language CHINESE_SIMPLIFIED;
    public static final Language CHINESE_TRADITIONAL;
    public static final Language SPANISH_LEGACY;
    public static final Language SPANISH;
    public static final Language RUSSIAN_LEGACY;
    public static final Language RUSSIAN;
    public static final Language NORWEGIAN_LEGACY;
    public static final Language NORWEGIAN_BOKMAL;
    public static final Language NORWEGIAN_NYNORSK;
    public static final Language DUTCH_LEGACY;
    ...
    static {
        ENGLISH_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("en"), new Language("en"));
        ...
        FRENCH_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("fr"), new Language("fr"));
        FRENCH = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("fr_fr"), new Language("fr_fr"));
        CHINESE_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("zh"), new Language("zh"));
        ...
        SPANISH_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("es"), new Language("es"));
        SPANISH = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("es_es"), new Language("es_es"));
        RUSSIAN_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("ru"), new Language("ru"));
        RUSSIAN = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("ru_ru"), new Language("ru_ru"));
        NORWEGIAN_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("no"), new Language("no"));
        ...
        DUTCH_LEGACY = Registry.register(LANGUAGE_REGISTRY, new ResourceLocation("nl"), new Language("nl"));
